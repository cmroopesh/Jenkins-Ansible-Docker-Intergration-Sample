pipeline{
 ...
 stage('DockerHub Push'){
        ...
        stage('Docker Deploy'){
            steps{
              ansiblePlaybook credentialsId: 'privateKey', disableHostKeyChecking: true, extras: "-e DOCKER_TAG=${DOCKER_TAG}", installation: 'ansible2', inventory: 'dev.inv', playbook: 'Deploy-docker.yml'
            }
        }
